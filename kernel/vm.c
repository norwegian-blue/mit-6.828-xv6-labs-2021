...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
// COW - Modification:
//  duplicate parent physical address into 
//  child pagetable and mark both pages as
//  read only. page fault handler will duplicate
//  physical memory only if an actual write is 
//  needed.
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
uvmcopy(pagetable_t old, pagetable_t new, uint64 sz)
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    pa = PTE2PA(*pte);
    *pte &= ~PTE_W;     // mark pages as read only for COW
    *pte |= PTE_C;      // mark as a COW page
    flags = PTE_FLAGS(*pte);
